...
import 'package:event_consent2/screens/venues/venue_detail_edit.dart';
import 'package:flutter/material.dart';

class Venues extends StatefulWidget {
  Venues({super.key, required this.userType});
  String userType;
  @override
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        //For adding Venue Directly From Page
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              const Text(
                'Add Venue',
                style: TextStyle(color: Color(0xff2980b9), fontSize: 35),
              ),
              const SizedBox(
                height: 20,
              ),
                ...
                onTap: () async {
                  ...
                  showDialog(
                    ...
                    builder: (BuildContext context) {
                      return Expanded(
                        child: AlertDialog(
                          title: const Text('Venue Added Succesfully'),
